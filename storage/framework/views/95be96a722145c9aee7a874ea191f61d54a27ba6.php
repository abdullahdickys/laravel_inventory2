...
<!-- Optional JS -->
<script src="<?php echo e(asset('argon assets/vendor/chart.js/dist/Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('argon assets/vendor/chart.js/dist/Chart.extension.js')); ?>"></script>
<!-- Argon JS -->
<script src="<?php echo e(asset('argon assets/js/argon.js?v=1.2.0')); ?>"></script>
<?php /**PATH /home/dr4g0na/Desktop/project/laravel_inventory2/resources/views/layouts/javascript.blade.php ENDPATH**/ ?>