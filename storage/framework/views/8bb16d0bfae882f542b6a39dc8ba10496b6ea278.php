              ...
              <div class="box-body">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="beli" class="form-control" id="exampleInputPassword1" placeholder="harga beli" value="<?php echo e($dt->beli); ?>">
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Harga Jual Product</label>
                  <input type="number" name="harga" class="form-control" id="exampleInputPassword1" placeholder="harga jual" value="<?php echo e($dt->harga); ?>">
                </div>
              </div>
              <!-- /.box-body -->
